...
class UniteOuvrier extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      ...
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/ouvrier5.png",square_size,square_size], 250, 50, "melee", 7, 1.5, 10, 1, "player", true, 0, null, true,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
    buildCaserne(){
      let goldCost = 400;
      let manaCost = 0;
    ...
    setButtons(){
      let unit = this;
      changeButton(1,"./img/game/iconeCaserne.jpg",function(event){unit.buildCaserne()}, "Caserne", "400 or - Bâtiment permettant la formation d'unités.");
      changeButton(2,"./img/game/humanTower.png",function(event){unit.buildTour()}, "Tour défensive", "300 or - Bâtiment défensif qui inflige des dégâts à distance.");
      changeButton(3,"./img/game/upgradePlayer.png",function(event){unit.buildAtelier()}, "Atelier de recherche", "350 or - Bâtiment permettant l'amélioration des unités.");
      changeButton(4,"./img/game/hdv1.png",function(event){unit.buildHdv()}, "Hôtel de ville", "700 or - Bâtiment permettant la formation d'Ouvriers et qui débloque des améliorations lorsqu'il est amélioré.");
    }
  }
  ...
  class UniteSoldat extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      ...
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/footman5.png",square_size,square_size], 250, 100, "melee", 15, 1.2, 10, 1, "player", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      this.level = [0,0];
      this.checkUpgrades();
    }
  ...
  class UniteTotem extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv,liste_totems) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/totemDead.png",square_size*3,square_size*3], 0, 1000, "melee", 0, 0, 0, 0, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      this.totemRange = 50;
    ...
    takeDamage(damage){
      ...
      if(this.health==0 && this.owner=="player"){
        ...
        this.changeImage("./img/game/totemDead.png");
        this.alive=false;
        this.owner="enemy";
    ...
    healTotem(nb){
      ...
      if(this.health<this.maxHealth){
        ...
        if(this.health==this.maxHealth){
          ...
          this.changeImage("./img/game/totemAlive.png");
          this.alive=true;
  ...
  class UniteSoigneur extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      ...
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/mage5.png",square_size,square_size], 250, 50, "ranged", 0, 2, 10, 8, "player", false, 400, ["./img/game/projectile_magique.png", square_size/2, square_size/2], false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      this.healAmount = 10;
      this.healLoop();
    }
  ...
  class UniteArcher extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      ...
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/archer5.png",square_size,square_size], 250, 60, "ranged", 15, 1.5, 10, 8, "player", false, 5000, ["./img/game/arrow.png", square_size/2, square_size/2], false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      this.level = 1;
      this.checkUpgrades();
    }
  ...
  class UniteGeant extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      ...
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/geant.gif",square_size*3,square_size*3], 200, 250, "melee", 25, 2, 10, 2, "player", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      this.level = [0,0];
      this.checkUpgrades();
    }
  ...
  class UniteLanceur extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      ...
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/archer5.png",square_size,square_size], 250, 60, "ranged", 20, 2, 10, 8, "player", false, 4000, ["./img/game/projectile_magique.png", square_size/2, square_size/2], false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      this.level = 1;
      this.checkUpgrades();
    }
  ...
  class UniteCavalier extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      ...
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/knight5.png",square_size,square_size], 350, 120, "melee", 20, 1.6, 10, 1, "player", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      this.level = [0,0];
      this.checkUpgrades();
    }
  ...
  class UniteCaserne extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/caserne.png",square_size*3,square_size*3], 0, 800, "melee", 0, 0, 0, 0, "player", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
    ...
    setButtons(){
      ...
      changeButton(1,"./img/game/iconeSoldat.jpg",function(event){unit.spawnSoldat()}, "Soldat", "100 or - Unité de mélée basique.");
      changeButton(2,"./img/game/iconeArcher.jpg",function(event){unit.spawnArcher()}, "Archer", "90 or - Unité à distance basique.");
      if(levelHdv>=1){
        changeButton(3,"./img/game/iconeMage.jpg",function(event){unit.spawnSoigneur()}, "Soigneur", "100 or, 50 mana - Unité passive qui soigne un allié proche.");
        changeButton(4,"./img/game/iconeCavalier.jpg",function(event){unit.spawnCavalier()}, "Cavalier", "150 or - Unité de mélée rapide.");
      }
      if(levelHdv>=2){
        changeButton(5,"./img/game/iconeGeant.jpg",function(event){unit.spawnGeant()}, "Géant", "250 or, 50 mana - Grande unité de mélée disposant de beaucoup de points de vie.");
        changeButton(6,"./img/game/archer5.png",function(event){unit.spawnLanceur()}, "Lanceuse de glaives", "250 or - Unité à distance qui lance des glaives pouvant rebondir sur deux cibles.");
      }
    }
  }
  ...
  class UniteHotelDeVille extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/hdv1.png",square_size*3,square_size*3], 0, 1000, "melee", 0, 0, 0, 0, "player", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    ...
    upgrade(){
      ...
      if(checkResources(goldCost,manaCost)){ //si le joueur a assez de ressources
        ...
        if(this.level==this.upgradeCosts.length){
          changeButton(9);
          this.changeImage("./img/game/hdv3.png");
        }
        else{
          changeButton(9,"./img/game/hdv3.png",function(event){unit.upgrade()}, "Niveau 3", "500 or - Débloque des unités à la caserne et des améliorations sur la tour et dans l'atelier de recherche.");
          this.changeImage("./img/game/hdv2.png");
        }
      }
      else{
        playSound("sound/Error.wav")
    ...
    setButtons(){
      let unit = this;
      changeButton(1,"./img/game/iconeOuvrier.jpg",function(event){unit.spawnOuvrier()}, "Ouvrier", "60 or - Unité de mélée capable de récolter de l'or dans les mines et du mana dans les arbres.");
      if(this.level<this.upgradeCosts.length){
        if(this.level==0){
          changeButton(9,"./img/game/hdv2.png",function(event){unit.upgrade()}, "Niveau 2", "350 or - Débloque des unités à la caserne et des améliorations sur la tour et dans l'atelier de recherche.");
        }
  ...
  class UniteMine extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv,goldMine) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/mine.png",square_size*3,square_size*3], 0, goldMine, "melee", 0, 0, 0, 0, "player", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteTour extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/humanTower.png",square_size*3,square_size*3], 0, 600, "ranged", 15, 1.75, 10, 10, "player", false, 5000, ["./img/game/arrow.png", square_size/2, square_size/2], false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    ...
    setButtons(){
      ...
      for(let n = 0; n<3; n++){
        if(!this.upgrades[n] && levelHdv>=this.upgradesHdv[n]){
          if(n==0){
            changeButton(7+n,"./img/game/tower.png",function(event){unit.upgrade(n)}, "Dégâts améliorés", "100 or - Augmente les dégâts de la tour.");
          }
          else if(n==1){
            changeButton(7+n,"./img/game/tower.png",function(event){unit.upgrade(n)}, "Vitesse d'attaque améliorée", "100 or - Augmente la vitesse d'attaque de la tour.");
          }
          else if(n==2){
            changeButton(7+n,"./img/game/tower.png",function(event){unit.upgrade(n)}, "Portée améliorée", "250 or - Augmente la portée et la vitesse des flèches.");
          }
        }
        else{
          changeButton(7+n);
  ...
  class UniteAtelier extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/upgradePlayer.png",square_size*3,square_size*3], 0, 1000, "melee", 0, 0, 0, 0, "player", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
      ...
      if(this.upgrades[n]<3 && levelHdv>=this.upgrades[n]){
        if(n==0){
          if(this.upgrades[n]==0){
            img = "./img/game/BTNSteelMelee.jpg";
          }
          else if(this.upgrades[n]==1){
            img = "./img/game/BTNThoriumMelee.jpg";
          }
          else if(this.upgrades[n]==2){
            img = "./img/game/BTNArcaniteMelee.jpg";
          }
          ...
          if(this.upgrades[n]==0){
            img = "./img/game/BTNHumanArmorUpOne.jpg";
          }
          else if(this.upgrades[n]==1){
            img = "./img/game/BTNHumanArmorUpTwo.jpg";
          }
          else if(this.upgrades[n]==2){
            img = "./img/game/BTNHumanArmorUpThree.jpg";
          }
          ...
          if(this.upgrades[n]==1){
            img = "./img/game/BTNStrengthOfTheMoon.jpg";
          }
          else if(this.upgrades[n]==2){
            img = "./img/game/BTNImprovedStrengthOfTheMoon.jpg";
          }
  ...
  class UniteEnnemi0 extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/Grunt5.png",square_size,square_size], 250, 100, "melee", 15, 1.2, 10, 1, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteEnnemi1 extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/ennemie1.png",square_size,square_size], 250, 100, "melee", 15, 1.2, 10, 1, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteEnnemi10 extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/ennemie10.png",square_size,square_size], 250, 60, "ranged", 25, 2, 10, 8, "enemy", false, 3500, ["./img/game/projectile_magique.png", square_size/2, square_size/2], false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteEnnemi11 extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/Troll5.png",square_size,square_size], 250, 60, "ranged", 15, 1.75, 10, 8, "enemy", false, 4000, ["./img/game/axe.png", square_size/2, square_size/2], false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteEnnemi20 extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/Ogre5.png",square_size,square_size], 250, 150, "melee", 10, 1.2, 10, 1, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteEnnemi21 extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":0, "type":"square"}, ["./img/game/ennemie21.png",square_size,square_size], 250, 150, "melee", 10, 1.2, 10, 1, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteBaseEnnemie extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/ennemieBase.png",square_size*3,square_size*3], 0, 1000, "melee", 0, 0, 0, 0, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  ...
  class UniteCaserneEnnemie extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/ennemieBarrak.png",square_size*3,square_size*3], 0, 800, "melee", 0, 0, 0, 0, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
  ...
  class UniteTourEnnemie extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/tower.png",square_size*3,square_size*3], 0, 600, "ranged", 15, 1.75, 10, 10, "enemy", false, 5000, ["./img/game/arrow.png", square_size/2, square_size/2], false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  ...
  class UniteAtelierEnnemi extends Unite {
    constructor(x = null, y = null,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv) {
      super(x, y, {"radius":1, "type":"square"}, ["./img/game/ennemieUpgrade.png",square_size*3,square_size*3], 0, 1000, "melee", 0, 0, 0, 0, "enemy", false, 0, null, false,liste_unites,gridContainer,square_size,gridLeft,gridTop,goldCollection,manaCollection,liste_hdv);
    }
  }
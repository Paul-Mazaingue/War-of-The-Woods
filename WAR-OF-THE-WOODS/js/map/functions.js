...
function drawMap(matrice, pixelSize = 1) {
    ...
    return new Promise((resolve, reject) => {
        ...
        // Images de l'arbre
        const treeImages = ['img/game/tree1.png', 'img/game/tree2.png', 'img/game/tree3.png'].map(src => {
            const img = new Image();
            img.src = src;
            return img;
        });
        ...
        ennemie1Img.src = 'img/game/ennemie1.png';

        const ennemie10Img = new Image();
        ennemie10Img.src = 'img/game/ennemie10.png';

        const ennemie11Img = new Image();
        ennemie11Img.src = 'img/game/ennemie11.png';

        const ennemie20Img = new Image();
        ennemie20Img.src = 'img/game/ennemie20.png';

        const ennemie21Img = new Image();
        ennemie21Img.src = 'img/game/ennemie21.png';
        ...
        ennemieUpgradeImg.src = 'img/game/ennemieUpgrade.png';

        const ennemieBarrakImg = new Image();
        ennemieBarrakImg.src = 'img/game/ennemieBarrak.png';
